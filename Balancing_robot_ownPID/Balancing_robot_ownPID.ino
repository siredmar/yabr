...
void setup(){
    ...
    Pid_Init(&Pid, 4, -400, 400);
    Pid_SetParameters(&Pid, pid_p_gain, pid_i_gain, pid_d_gain);
}
...
void loop(){
    ...
    //  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    Pid_SetSetpoint(&Pid, pid_setpoint);
    pid_output = Pid_Handler(&Pid,  angle_gyro - self_balance_pid_setpoint);
    pid_output *= -1;
    if(outputPidValue == 1)
    {
    ...
    if(pid_output > 10 || pid_output < -10)
        Pid_AddToError(&Pid, pid_output * 0.015);
